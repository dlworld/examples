...
compile_config="/root/neutron.conf"
...
%pre common
getent group neutron >/dev/null || groupadd -r neutron -g 161
getent passwd neutron >/dev/null || \
useradd -u 161 -r -g neutron -d %{_sharedstatedir}/neutron -s /sbin/nologin \
...
%{_bindir}/neutron-brctl-cleanup
%{_bindir}/neutron-pd-notify
%{_bindir}/neutron-sanity-check
%{_bindir}/neutron-server
%{_bindir}/neutron-usage-audit
%{_bindir}/oe-neutron-linuxbridge-agent
...
/usr/bin/neutron-dvs-agent
/usr/bin/neutron-vserver-agent
