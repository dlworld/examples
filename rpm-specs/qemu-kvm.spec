...
# For bz#1207687 - [6wind 7.2 FEAT]: vhost-user does not support multique
Patch454: kvm-virtio-blk-only-clear-VIRTIO_F_ANY_LAYOUT-for-legacy.patch
# For bz#1207687 - [6wind 7.2 FEAT]: vhost-user does not support multique
Patch455: kvm-vhost-enable-vhost-without-without-MSI-X.patch
# For bz#1207687 - [6wind 7.2 FEAT]: vhost-user does not support multique
Patch456: kvm-vhost-user-Send-VHOST_RESET_OWNER-on-vhost-stop.patch
# For bz#1207687 - [6wind 7.2 FEAT]: vhost-user does not support multique
Patch457: kvm-virtio-avoid-leading-underscores-for-helpers.patch
# For bz#1207687 - [6wind 7.2 FEAT]: vhost-user does not support multique
Patch458: kvm-vhost-user-use-VHOST_USER_XXX-macro-for-switch-state.patch
# For bz#1207687 - [6wind 7.2 FEAT]: vhost-user does not support multique
Patch459: kvm-vhost-user-add-protocol-feature-negotiation.patch
# For bz#1207687 - [6wind 7.2 FEAT]: vhost-user does not support multique
Patch460: kvm-vhost-rename-VHOST_RESET_OWNER-to-VHOST_RESET_DEVICE.patch
# For bz#1207687 - [6wind 7.2 FEAT]: vhost-user does not support multique
Patch461: kvm-vhost-user-add-VHOST_USER_GET_QUEUE_NUM-message.patch
# For bz#1207687 - [6wind 7.2 FEAT]: vhost-user does not support multique
Patch462: kvm-vhost-introduce-vhost_backend_get_vq_index-method.patch
# For bz#1207687 - [6wind 7.2 FEAT]: vhost-user does not support multique
Patch463: kvm-vhost-user-add-multiple-queue-support.patch
# For bz#1207687 - [6wind 7.2 FEAT]: vhost-user does not support multique
Patch464: kvm-vhost-user-add-a-new-message-to-disable-enable-a-spe.patch
...
Patch1000: kvm-hw-usbredir-handle-attach.patch
Patch1001: qemu-kvm-fix-xhci-crash.patch
...
%changelog
* Fri Mar 3 2017 dlw <denglinwen@os-easy.com> - rhev-2.3.0-34.el7
- qemu-kvm-fix-xhci-crash.patch

* Thu Nov 17 2016 dlw <denglinwen@os-easy.com> - rhev-2.3.0-33.el7
- kvm-hw-usbredir-handle-attach.patch

* Mon Jan 18 2016 sunjun <sunjun@os-easy.com> - rhev-2.3.0-32.el7
- modify config add host_cdrom
