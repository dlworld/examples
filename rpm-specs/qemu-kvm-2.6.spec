...
install -p -m 0644 -t ${RPM_BUILD_ROOT}%{qemudocdir} Changelog README  COPYING COPYING.LIB LICENSE %{SOURCE19} docs/qmp-events.txt docs/qmp-spec.txt
...
mkdir -p $RPM_BUILD_ROOT%{_sysconfdir}/%{pkgname}
