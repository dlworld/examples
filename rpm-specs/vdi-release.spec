...
%define product_family Vdi
%define variant_titlecase Server
%define variant_lowercase server
%define release_name Core
%define base_release_version 1
%define full_release_version 4.3
%define dist_release_version 1
%define upstream_rel 4.3
%define centos_rel 0
#define beta Beta
%define dist .el7
...
Source0:        vdi-release-%{base_release_version}.tar.gz
...
%prep
%setup -q -n vdi-release-%{base_release_version}
...
echo "%{product_family} release %{full_release_version} " > %{buildroot}/etc/centos-release
...
CENTOS_MANTISBT_PROJECT="Vdi-1"
CENTOS_MANTISBT_PROJECT_VERSION="1"
REDHAT_SUPPORT_PRODUCT="vdi"
REDHAT_SUPPORT_PRODUCT_VERSION="1"

EOF
# write cpe to /etc/system/release-cpe
echo "cpe:/o:vdi:vdi:7" > %{buildroot}/etc/system-release-cpe
